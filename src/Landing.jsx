...
export default function Landing({ onEmpezar, onLogin }) {
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", fontFamily: "'Styrene A', -apple-system, BlinkMacSystemFont, sans-serif", color: C.text, overflowX: "hidden", position: "relative" }}>
      ...
      <a href="https://wa.me/541122987419?text=Hola!%20Quiero%20saber%20más%20sobre%20TuPersonal" target="_blank" rel="noopener noreferrer"
        aria-label="Contactar por WhatsApp"
        style={{ position: "fixed", bottom: 24, right: 24, zIndex: 200, width: 56, height: 56, borderRadius: "50%", background: "#25D366", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 6px 24px rgba(37,211,102,0.4)", textDecoration: "none" }}>
