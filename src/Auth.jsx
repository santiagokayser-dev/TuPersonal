...
const COLORS = {
  bg: "#0D0D0F", surface: "#1a1a1e", border: "#2a2a2e",
  accent: "#6366f1", accentSub: "#312e81", text: "#fff",
  textMuted: "#666", green: "#4ade80", red: "#f87171",
}
      ...
      {opciones.map(o => {
        ...
        return (
          <motion.button key={o.id} whileTap={{ scale: 0.97 }} onClick={() => onChange(o.id)}
            ...
            <div style={{ fontSize: 11, color: activo ? "#a5b4fc" : "#444", lineHeight: 1.4 }}>{o.desc}</div>
          </motion.button>
        )
      })}
    </div>
...
export default function Auth() {
  ...
  return (
    <div style={S.container}>
      <div style={S.phone}>
        <div style={S.logo}>TuPersonal<span style={{ color: COLORS.accent }}>.</span></div>

        {inviteTrainerId && (
          <div style={{ background: "#312e8133", border: `0.5px solid ${COLORS.accent}33`, borderRadius: 12, padding: "10px 14px", marginBottom: 20, fontSize: 13, color: "#a5b4fc" }}>
